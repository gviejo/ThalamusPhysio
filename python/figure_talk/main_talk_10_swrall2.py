...
# F SWR NUCLEUS
#####################################################################
gsm = gridspec.GridSpecFromSubplotSpec(len(nucleus)+1,1, subplot_spec = gs[:,1], height_ratios = [1]+[0.1]*len(nucleus))
...
savefig(r"../../../Dropbox (Peyrache Lab)/Talks/fig_talk_21.png", dpi = 300, facecolor = 'white')
