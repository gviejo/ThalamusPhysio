...
scatter(space[space['hd'] == 1][1]*-1.0, space[space['hd'] == 1][0]*-1, s = 20, marker = 'o', facecolor = 'white', edgecolor = 'black', linewidth = 0.5, label = 'HD neuron', alpha = 0.8)
...
savefig(r"../../../Dropbox (Peyrache Lab)/Talks/fig_talk_7.png", dpi = 300, facecolor = 'white')
