...
for session in datasets:
	...
	if np.sum(hd_info)>10:
		print(session, np.sum(hd_info))
		...
		# for i in range(1):
			...
			savefig("../figures/figures_articles_v4/figure1/ex_swr_"+session.split("/")[1]+"_"+'{:03}'.format(i)+".pdf", dpi = 900, facecolor = 'white')
			# os.system("evince ../figures/figures_articles_v4/figure1/ex_swr_9.pdf &")


		os.system("pdftk ../figures/figures_articles_v4/figure1/ex_swr_*.pdf cat output ../figures/figures_articles_v4/figure1/swr_all_exemples_"+session.split("/")[1]+".pdf")
