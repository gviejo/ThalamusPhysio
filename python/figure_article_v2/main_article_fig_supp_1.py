...
simpleaxis(axA)
axA.text(-0.30, 1.01, "A", transform = axA.transAxes, fontsize = 10)
...
savefig("../../figures/figures_articles_v2/figart_supp_1.pdf", dpi = 900, facecolor = 'white')
os.system("evince ../../figures/figures_articles_v2/figart_supp_1.pdf &")
