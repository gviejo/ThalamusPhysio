...
for session in datasets:
	...
	if np.sum(hd_info == 0)>10:		
		...
		left_bound = np.arange(-1000-3*bin_size/4, 1000 - 3*bin_size/4,3*bin_size/4) # 25% overlap		
		...
		cPickle.dump(datatosave, open('../figures/figures_articles_v4/figure1/nohd_isomap_20ms_mixed_swr_rnd_wake/'+session.split("/")[1]+'.pickle', 'wb'))
