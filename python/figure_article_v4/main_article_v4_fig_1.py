...
outergs = GridSpec(2,1, figure = fig, height_ratios = [0.3, 0.7])
...
gs_bot = gridspec.GridSpecFromSubplotSpec(1,2, subplot_spec = outergs[1,0], width_ratios = [0.8, 0.5], wspace = 0.45)
####################################################################
# C RING
####################################################################
