...
gs = gridspec.GridSpec(4,1, wspace = 0.4, hspace = 0.5)
...
for i, m in enumerate(['Mouse17', 'Mouse12', 'Mouse20', 'Mouse32']):
...
savefig("../../figures/figures_articles/figart_supp_4.pdf", dpi = 900, bbox_inches = 'tight', facecolor = 'white')
os.system("evince ../../figures/figures_articles/figart_supp_4.pdf &")
